package net.czming.detection.review.feign.config;
...
@Configuration
public class ViolationDispositionFeignConfig {



    private final InternalAuthProperties internalAuthProperties;

    public ViolationDispositionFeignConfig(InternalAuthProperties internalAuthProperties) {
